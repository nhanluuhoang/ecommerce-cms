            ...
            <div id="page-404">
                <section>
                    <div className="ant-result ant-result-404">
                            ...
                            <svg width="252" height="294">
                                ...
                                <g fill="none" fillRule="evenodd">
                                    ...
                                    <path
                                        ...
                                        stroke="#648BD8" strokeWidth="1.051" strokeLinecap="round"
                                        strokeLinejoin="round"></path>
                                    <path d="M107.275 222.1s2.773-1.11 6.102-3.884" stroke="#648BD8"
                                    ...
                                    <path
                                        ...
                                        fill="#552950"></path>
                                    <path stroke="#DB836E" strokeWidth="1.118" strokeLinecap="round"
                                          strokeLinejoin="round" d="M110.13 74.84l-.896 1.61-.298 4.357h-2.228"></path>
                                    <path d="M110.846 74.481s1.79-.716 2.506.537" stroke="#5C2552" strokeWidth="1.118"
                                          strokeLinecap="round" strokeLinejoin="round"></path>
                                    <path
                                        d="M92.386 74.282s.477-1.114 1.113-.716c.637.398 1.274 1.433.558 1.99-.717.556.159 1.67.159 1.67"
                                        stroke="#DB836E" strokeWidth="1.118" strokeLinecap="round"
                                        strokeLinejoin="round"></path>
                                    <path d="M103.287 72.93s1.83 1.113 4.137.954" stroke="#5C2552" strokeWidth="1.118"
                                          strokeLinecap="round" strokeLinejoin="round"></path>
                                    <path
                                    ...
                                    <path d="M81.45 89.384s.45 5.647-4.935 12.787M69 82.654s-.726 9.282-8.204 14.206"
                                          stroke="#E4EBF7" strokeWidth="1.101" strokeLinecap="round"
                                          strokeLinejoin="round"></path>
                                    <path d="M129.405 122.865s-5.272 7.403-9.422 10.768" stroke="#E4EBF7"
                                          strokeWidth="1.051" strokeLinecap="round" strokeLinejoin="round"></path>
                                    <path d="M119.306 107.329s.452 4.366-2.127 32.062" stroke="#E4EBF7"
                                    ...
                                    <path
                                        ...
                                        stroke="#DB836E" strokeWidth="1.051" strokeLinecap="round"
                                        strokeLinejoin="round"></path>
                                    <path d="M145.16 135.877c-1.85 1.346.561 2.355.561 2.355s3.478.898 6.73.617"
                                          stroke="#DB836E" strokeWidth="1.051" strokeLinecap="round"
                                          strokeLinejoin="round"></path>
                                    <path
                        ...
                        <div className="ant-result-subtitle">Sorry, the page you visited does not exist.</div>
                        <div className="ant-result-extra"><a href="/dashboard">
                            <button type="button" className="ant-btn ant-btn-primary"><span role="img" aria-label="home"
                                                                                            className="anticon anticon-home"><svg
